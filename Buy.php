...
<form id ="buyform" name = "myform" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
<div class="input-group">
<label for="sname">Fullname</label>
<input type="text" name="name" pattern ="[A-Za-z\s]{6,}" title="name must be atleast 3 letters" required="required"  />
...
<input type="text" name="apartment"  pattern ="[A-Za-z\s]{3,}" title="name must be atleast 3 letters" required="required"/>


</div>
<div class="input-group">
<label for="location">Apt-Location(eg Manyatta) </label>
<input type="text" name="location"  pattern ="[A-Za-z\s]{6,}" required="required" />

</div>
<div class="input-group">
<button type="submit" class="btn" name="reg1">Submit</button>
</div>
</form>
</main>
<br>
...
<p>&copy Copyright Millan.All Reserved<br/>Powered by Millan Web 
Creator.</p>
</footer>
</article>
</body>
